...
- RELATION_COEF(D-14) · CONFIRMED_COEF(D-08) · GRADE_THRESHOLDS(D-16): 정답지 점수 분포 확인 후 B 조정.
...
# D-16 기본값 — materiality 가 threshold 이상이면 그 등급(위에서부터 첫 매치). 정답지 점수 분포 확인 후 B 조정
GRADE_THRESHOLDS: list[tuple[str, int]] = [("심각", 80), ("경고", 70), ("주의", 0)]
